...
#        assert imgH % 16 == 0, 'imgH has to be a multiple of 16'
        ...
        convRelu(2, True)                                                     
        convRelu(3)                                                        
        cnn.add_module('pooling{0}'.format(2), nn.MaxPool2d(2,2))    # 512x8x24 
        convRelu(4, True)
        convRelu(5)                                                  # 512x6x22 
        cnn.add_module('pooling{0}'.format(3), nn.MaxPool2d((2, 2), (2, 1), (0, 1)))  # 512x3x23 
        convRelu(6, True)  # 512x1x21 
